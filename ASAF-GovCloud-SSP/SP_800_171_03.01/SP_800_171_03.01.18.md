...
- **MDM scope**: If mobile devices are used for administrative notifications (SNS, Security Hub alerts), they do not process CUI. Email clients on mobile devices receive alert summaries only â€” no CUI content.
- **CRMA mobile restriction**: $(System.Collections.Hashtable.Policies) Section 6.1 prohibits processing of CUI on personal mobile devices. Only approved, org-managed CRMAs (Windows 11 workstations) are authorized.
