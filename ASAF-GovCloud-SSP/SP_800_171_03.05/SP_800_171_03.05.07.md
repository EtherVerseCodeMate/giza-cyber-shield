...
- **Minimum length (ODP A.03.05.07.ODP.01)**: 14 characters â€” enforced by Cognito User Pool password policy. Also requires: at least 1 uppercase, 1 lowercase, 1 number, 1 symbol.
- **Password reuse (ODP A.03.05.08.ODP.01)**: 24 previous passwords â€” Cognito PasswordHistoryPolicy prevents reuse of the last 24 passwords.
