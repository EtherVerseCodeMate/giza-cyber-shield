...
- **CUI in transit**: All CUI transmitted over networks is encrypted with TLS 1.2+ (AES-256-GCM) enforced by $(System.Collections.Hashtable.ALB). $(System.Collections.Hashtable.SCPForceTLS) SCP denies any S3 or API access without HTTPS.
