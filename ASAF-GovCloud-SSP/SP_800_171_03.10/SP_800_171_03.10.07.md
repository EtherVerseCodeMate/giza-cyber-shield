...
- **Print prohibition**: CUI output is prohibited from being printed. All compliance documentation maintained in digital format only, stored in $(System.Collections.Hashtable.S3Evidence).
