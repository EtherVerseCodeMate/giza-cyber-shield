...
- **SSP review frequency (ODP.01)**: annually + within 30 days of significant change.
- **SSP format**: NIST SP 800-171 Rev 3 control structure, trestle OSCAL markdown format, assembled to OSCAL JSON via 	restle author ssp-assemble.
...
- **POA&M Reference**: B-14 (Complete SSP as part of C3PAO assessment package â€” Sprint 42)
