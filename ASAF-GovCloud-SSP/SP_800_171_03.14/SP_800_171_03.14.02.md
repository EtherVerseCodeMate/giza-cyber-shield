...
- **Alert recipients (ODP.01)**: System Owner ($(System.Collections.Hashtable.SystemOwner)) via SNS $(System.Collections.Hashtable.SNSTopic); Security Hub email digest weekly.
...
- **NVD/NIST**: $(System.Collections.Hashtable.Inspector) feeds from NVD and additional threat intelligence. CRITICAL CVEs generate immediate Security Hub findings.
- **Go vulnerability database**: $(System.Collections.Hashtable.GovulnCheck) scans Go dependencies against the Go vulnerability database (vuln.go.dev) on every CI run.
