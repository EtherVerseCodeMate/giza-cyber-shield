...
echo "  3. scp bin/asaf-apiserver-linux-amd64 root@agent.souhimbou.ai:/opt/asaf/"
echo "  4. scp bin/asaf-webhook-linux-amd64   root@agent.souhimbou.ai:/opt/asaf/"
echo "  5. ssh root@agent.souhimbou.ai systemctl restart asaf-gateway asaf-webhook"
