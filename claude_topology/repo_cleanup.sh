...
echo "  telemetry.souhimbou.org on Cloudflare Workers + D1:"
...
echo "  3. Update DNS: telemetry.souhimbou.org → A record → 187.124.225.91"
...
echo "║    □ Update DNS telemetry.souhimbou.org → VPS     ║"
