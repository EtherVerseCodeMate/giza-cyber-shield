...
> Note: this audit was originally merged into `nouchix/PQC-Khepra-MCP#16` (production main).
> That was a mistake — this work belongs in the dev/protocol repo, not production. Filing it
> here instead. The production copy is being left in place (it's docs-only and harmless) rather
> than reverted.
