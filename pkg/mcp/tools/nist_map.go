// Package tools — nist_map: offline BM25 semantic control mapping.
//
// Zero-API-call, air-gap-safe search across NIST 800-53 Rev 5,
// NIST 800-171 Rev 2, CMMC 2.0, and STIG CCI mappings.
package tools
...
// embeddedControls is a representative subset of NIST 800-53 Rev 5 + CMMC 2.0.
// In production, replaced by the full STIG-to-NIST mapping xlsx at runtime.
var embeddedControls = []ControlRecord{
	...
	{ID: "IA-2", Title: "Identification and Authentication", Description: "Uniquely identify and authenticate organizational users and associate that unique identification with processes acting on behalf of those users.", Framework: "NIST-800-53", Family: "IA"},
	...
	{ID: "CM.L2-3.4.2", Title: "Establish Security Config Baseline", Description: "Establish and maintain baseline configurations and inventories of organizational systems throughout the respective system development life cycles.", Framework: "CMMC-L2", Family: "CM"},
