...
const InteractiveDemoVideo = () => {
  ...
  const demoSteps = [
    {
      userMessage: "AdinKhepra, analyze current threat landscape",
      ...
      <div className="p-6 min-h-[500px] flex flex-col">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">AdinKhepra ASAF Agent</h3>
                  ...
                  {message.type === 'user' ? (
                    ...
                    <>
                      ...
                      <div className="bg-gray-800 text-white rounded-lg px-4 py-2 max-w-md">
                        <div className="text-sm">{message.content}</div>
                        <div className="text-xs text-gray-400 mt-1">AdinKhepra ASAF • Now</div>
