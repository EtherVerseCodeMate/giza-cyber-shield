...
-- Add comprehensive check constraint including existing and strategic categories
ALTER TABLE integrations_library ADD CONSTRAINT integrations_library_category_check 
CHECK (category IN (
  -- Strategic niche-focused categories (primary)
  ...
  -- Existing categories (maintained for compatibility)
  'CLOUD',
  'COMPLIANCE', 
  'ENDPOINT',
  'FIREWALL',
...
-- Clear all existing data to load strategic integrations
TRUNCATE integrations_library;

-- Insert strategic niche-focused integrations aligned with our target market
...
-- DoD TACTICAL & STRATEGIC SYSTEMS (Primary Target: DoD Contractors)
('DoD Enterprise Email (DISA)', 'DISA', 'DOD_TACTICAL', 
'Defense Information Systems Agency enterprise email security integration for DoD contractors',
...
'Army distributed intelligence processing and dissemination system for battlefield operations',
...
'Cross-domain solution monitoring for classified/unclassified networks in defense environments',
...
('GCCS (Global Command Control System)', 'DoD CIO', 'DOD_TACTICAL',
'Global military command and control system integration for defense operations',
...
-- CRITICAL INFRASTRUCTURE OT/ICS/SCADA (Primary Target: Critical Infrastructure Operators)
('Schneider Electric EcoStruxure', 'Schneider Electric', 'INDUSTRIAL_OT',
'Industrial automation and energy management platform security for critical infrastructure',
...
'Power grid automation and protection system monitoring for electric utilities',
...
'Process control system for critical infrastructure and industrial facilities',
...
'Industrial automation security and access control for manufacturing operations',
...
-- AI ENTERPRISE & CONTAINER SECURITY (Primary Target: AI Agents in Enterprise)
('NVIDIA Morpheus AI Security', 'NVIDIA', 'AI_SECURITY',
'AI-powered cybersecurity framework for enterprise AI workloads and inference engines',
...
'Container orchestration security for AI workloads and model deployment',
...
'Machine learning lifecycle security and governance for enterprise AI/ML pipelines',
...
'Data integration and AI platform for defense and critical infrastructure analytics',
...
-- AIR-GAPPED & TACTICAL EDGE (Primary Target: Air-gapped & SCIF Systems)
('Disconnected Operations Security Monitor', 'Raytheon', 'AIR_GAPPED',
'Security monitoring for air-gapped and tactical edge systems in isolated environments',
...
'Sensitive Compartmented Information Facility network security for classified environments',
