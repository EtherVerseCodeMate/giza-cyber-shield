...
-- Insert default integration adapters
...
(
  ...
  '["servers-windows", "servers-linux", "cloud-aws", "cloud-azure", "cloud-gcp"]',
  'high'
),
(
  ...
  '["cloud-aws", "cloud-azure", "cloud-gcp", "containers-k8s", "web-api-rest"]',
  'high'
),
(
  '00000000-0000-0000-0000-000000000000',
  ...
  '["network-routers", "network-security", "network-wireless", "industrial-scada"]',
  'medium'
),
(
  '00000000-0000-0000-0000-000000000000',
  ...
  '["industrial-plc", "industrial-scada", "industrial-hmi", "energy-solar", "energy-wind", "energy-battery"]',
  'high'
),
(
  '00000000-0000-0000-0000-000000000000',
  ...
  '["containers-docker", "containers-k8s"]',
  'high'
),
(
  '00000000-0000-0000-0000-000000000000',
  ...
  '["servers-windows", "servers-linux", "network-infrastructure", "iot-sensors", "mobile-devices"]',
  'low'
);
