...
export const SecurityDashboard = () => {
  ...
  const loadSecurityMetrics = async () => {
    ...
    try {
      ...
      // Load security events scoped to this organization
      ...
      // Load critical alerts scoped to this organization
      ...
      // Load resolved incidents from last 30 days scoped to this organization
      ...
      // Load MFA enabled users scoped to org members
          ...
          <TabsContent value="overview" className="mt-6">
            {metricsLoading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[...new Array(6)].map((_, i) => (
                  <Card key={`skeleton-${i}`} className="card-cyber">
            ...
            <Card className="card-cyber mt-6">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <button
                    type="button"
                    className="p-4 border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors text-left w-full"
              ...
              <Card className="card-cyber">
                ...
                <CardContent>
                  ...
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <button
                      type="button"
                      className="p-4 border rounded-lg hover:bg-muted/20 transition-colors cursor-pointer text-left w-full"
